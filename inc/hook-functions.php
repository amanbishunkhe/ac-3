...
function rws_banner_section(){
    ...
    print_r($meta);
    echo "</pre>";*/
   echo   $banner_image_enable    = $meta['banner_image_enable'];
   echo $banner_image_id        = $meta['banner_group_1'];

    echo $banner_heading_enable  = $meta['banner_heading_enable'];
    echo $page_title             = $meta['rws_page_title'];
    echo $page_subtitle          = $meta['rws_page_subtitle'];
    
    echo $rws_banner_lablel_btn_enable  = $meta['rws_banner_btn_enable'];
    echo $rws_banner_btn_label   = $meta['rws_banner_btn_label'];
    echo $rws_banner_btn_url     = $meta['rws_banner_btn_url'];


    if ( $banner_image_enable == 1 ):    
      // echo '<pre>';
      // print_r($banner_image_id);
      // echo '</pre>';
      foreach ($banner_image_id as $value) {
      echo  $image_url_id= $value['banner_image'];
      }
        $banner_image_url   = rws_image_src ( array ( 'id' => $image_url_id, 'size' => 'full' ) );
    ?>
